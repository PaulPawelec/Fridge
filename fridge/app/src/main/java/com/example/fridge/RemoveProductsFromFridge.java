...
public class RemoveProductsFromFridge extends AppCompatActivity implements MarkProductAsBoughtAdapter.SelectedProduct{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remove_products_from_fridge);
        ...
        recyclerview = findViewById(R.id.RecyclerviewRemoveProductsFromFridge);
        acceptButton = findViewById(R.id.AcceptFloatingButtonRemoveProductsFromFridge);
        ...
        String messageToServer = "0409\n"+"q";
        RemoveProductsFromFridge.MessageSender messageSender = new RemoveProductsFromFridge.MessageSender();
        try {
    ...
    public void selectedProducts(Products product) {
        startActivity(new Intent(RemoveProductsFromFridge.this, SelectedProduct.class).putExtra("data", product));
    }
    class MessageSender extends AsyncTask<String,Void,Void> {
        ...
        protected Void doInBackground(String... voids) {
            ...
            RemoveProductsFromFridge.Odbjur odbjur = new RemoveProductsFromFridge.Odbjur();
        ...
        public boolean serverRequest(String request) {
            ...
            try (Socket socket = new Socket(hostname, port)) {
                ...
                if (serverMessage.equals("null"))
                    ...
                    else if (serverMessage.startsWith("0409")) {
