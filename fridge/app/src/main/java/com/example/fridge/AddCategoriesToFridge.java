...
public class AddCategoriesToFridge extends AppCompatActivity implements CategoriesAdapter.SelectedCategory {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_categories_to_fridge);
        ...
        recyclerview = findViewById(R.id.RecyclerviewAddCategoriesToFridge);
        recyclerview.setLayoutManager(new LinearLayoutManager(this));
        recyclerview.addItemDecoration(new DividerItemDecoration(this,DividerItemDecoration.VERTICAL));

        String message="0703\n";
        AddCategoriesToFridge.MessageSender messageSender = new AddCategoriesToFridge.MessageSender();
        try {
    ...
    public void selectedCategory(Categories product) {
        startActivity(new Intent(AddCategoriesToFridge.this, SelectedCategory.class).putExtra("data",product));
    }
    class MessageSender extends AsyncTask<String,Void,Void> {
        ...
        protected Void doInBackground(String... voids) {
            ...
            AddCategoriesToFridge.Odbjur odbjur = new AddCategoriesToFridge.Odbjur();
